...
//CONSTRUCTION SYSTEM (Player Self-Action Handles)
	s_build_Land_CamoNetB_EAST =		-1;
	s_build_Fort_RazorWire		 =	-1;
	s_build_Land_HBarrier5 	=	-1;
	s_build_Land_fortified_nest_small =	-1;
	s_build_Land_Fort_Watchtower =	-1;
};
