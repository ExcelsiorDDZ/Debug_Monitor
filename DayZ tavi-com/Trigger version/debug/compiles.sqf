...
if (!isDedicated) then {
	...
	building_spawnLoot =		compile preprocessFileLineNumbers "\kh\dayztaviana\compile\building_spawnLoot.sqf";
	...
	player_chopWood =			compile preprocessFileLineNumbers "\kh\dayztaviana\actions\player_chopWood.sqf";
...
//Both
	...
	if (isNil "kh_replacementWeatherCode") then
	{
		execVM "\z\addons\dayz_code\external\DynamicWeatherEffects.sqf";
	}
	else
	{
		[] call kh_replacementWeatherCode;
	};
